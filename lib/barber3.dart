...
class BarbeiroInfoPage3 extends StatefulWidget {
  const BarbeiroInfoPage3({Key? key}) : super(key: key);

  @override
  _BarbeiroInfoPage3State createState() => _BarbeiroInfoPage3State();
}

class _BarbeiroInfoPage3State extends State<BarbeiroInfoPage3> {
  ...
  final String linkMaps = 'https://www.google.com/maps/search/?api=1&query=-29.92366928349695, -51.180817147885485'; // Link para abrir no Google Maps
